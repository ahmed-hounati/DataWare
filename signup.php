                    ...
                    <form class="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div class="rounded-md shadow-sm -space-y-px">
                            <div class="p-2">
                                ...
                                <input id="first-name" name="first-name" type="text" autocomplete="" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="First-name">
                            </div>
                            <div class="p-2">
                                <label for="Last-name" class="sr-only">Last name</label>
                                <input id="Last-name" name="Last-name" type="text" autocomplete="" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Last-name">
                            </div>
                            <div class="p-2">
                                <label for="tel" class="sr-only">Phone-number</label>
                                <input id="tel" name="first-name" type="tel" autocomplete="" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Phone-number">
                            </div>
                            <div class="p-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="./login.php" class="text-indigo-600">Login?</a>
                        </div>
